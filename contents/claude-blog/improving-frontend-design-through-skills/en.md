...
In addition to the issue with design taste explored above, Claude has another default behavior that limits its ability to generate fantastic frontend artifacts in [claude.ai](http://claude.ai/redirect/claudedotcom.v1.ff4c28a4-3d1c-4f57-91ce-8f8dbf58ec75). Currently, when asked to create a frontend, Claude just builds a single HTML file with CSS and JS. This is because Claude understands that frontends must be single HTML files to be properly rendered as artifacts.
...
To try out this new skill in [Claude.ai](http://claude.ai/redirect/claudedotcom.v1.ff4c28a4-3d1c-4f57-91ce-8f8dbf58ec75), simply enable the skill and then ask Claude to “use the web-artifacts-builder skill” when building artifacts.
