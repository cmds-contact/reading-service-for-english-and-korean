#!/usr/bin/env node
/**
 * Google Blog Pipeline - Self-Improving Agent
 * scraper-core를 사용한 간소화된 파이프라인
 *
 * Usage: node pipeline.js "https://blog.google/outreach/example-post" [--force]
 */
...
if (require.main === module) {
  ...
  if (!url) {
    console.error('Usage: node pipeline.js "https://blog.google/outreach/example-post" [--force]');
    console.error('');
